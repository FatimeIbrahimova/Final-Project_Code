...
const Navbar = () => {
	...
	useEffect(() => {
		axios
			.get(`http://localhost:8080/allProductt`)
			...
			<div className="nav">
				<div className="container">
					...
					<div className="nav__right-icons burger">
						...
						></i>
						<i
							className="fa-solid fa-bars active"
							onClick={() => handleClick()}
						></i>
					</div>
				</div>
					...
					<div className="nav_list">
						...
						<div className="nav-footer">
							...
							<ul>
								...
								<li>
									<a href="https://www.instagram.com/redqinc/">
										<i className="fa-brands fa-instagram"></i>
									</a>
								</li>
								<li>
									<a href="https://twitter.com/redqinc">
										<i className="fa-brands fa-twitter"></i>
									</a>
								</li>
								<li>
									<a href="https://www.linkedin.com/company/redqinc/">
										<i className="fa-brands fa-linkedin"></i>
									</a>
								</li>
							</ul>
					...
					<div className="search_wrapper">
						{filter &&
							filter
								...
								.map((data, index) => (
									<a href={`${data._id}`}>
										<div className="search_wrapper-inner" key={index}>
