			...
			<div className="about">
				<div className="container">
					<div className="about_page-desc">
						...
						<p>
							StoryHub is a beautiful Gatsby Blog theme designed to showcase
							your work in style. Perfect for designers, artists, photographers
							and developers to use for their portfolio website.
						</p>
					</div>
					<div className="about_page-img">
						<img
							src="https://storyhub-beauty-redq.vercel.app/static/653c0632ece5d5e9f457ea515248b26b/49aac/about.jpg"
							alt="img"
						/>
					</div>
